...
<div class="flex h-full">
    <!-- Narrow sidebar -->
    <div class="hidden w-28 overflow-y-auto bg-gray-800 md:block">
...
<!--                   aria-current="page">-->
<!--                    &lt;!&ndash; Heroicon name: outline/photo &ndash;&gt;-->
...
<!--                    </svg>-->
<!--                    <span class="mt-2">Sales Sheets</span>-->
<!--                </a>-->
...
<!--                    </svg>-->
<!--                    <span class="mt-2">Lab Tests</span>-->
<!--                </a>-->

<!--                <a href="#"-->
<!--                   class="text-indigo-100 hover:bg-indigo-800 hover:text-white group w-full p-3 rounded-md flex flex-col items-center text-xs font-medium">-->
<!--                    &lt;!&ndash; Heroicon name: outline/rectangle-stack &ndash;&gt;-->
<!--                    <svg class="text-indigo-300 group-hover:text-white h-6 w-6" xmlns="http://www.w3.org/2000/svg"-->
<!--                         fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">-->
<!--                        <path stroke-linecap="round" stroke-linejoin="round"-->
...
<!--                </a>-->
    ...
    <div transition:slide class="relative z-20 md:hidden" role="dialog" aria-modal="true">
        <!--
                ...
                <div class="flex flex-1 justify-between px-4 sm:px-6">
                    ...
                    <div class="ml-2 flex items-center space-x-4 sm:ml-6 sm:space-x-6">
                        ...
                        <div class="relative flex-shrink-0">
                            ...
                            -->
                            {#if dropdownVisible}
                            <div transition:fade={{duration: 100}} class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
